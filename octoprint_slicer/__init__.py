...
class SlicerPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/profile_overrides.js", "js/slicer.js", "js/three.min.js", "js/STLLoader.js", "js/OrbitControls.js", "js/TransformControls.js", "js/Detector.js", "js/OrbitControls.js", "js/TransformControls.js", "js/STLBinaryExporter.js", "js/Intersection2D.js", "js/Octree.js"],
			css=["css/slicer.css"],
